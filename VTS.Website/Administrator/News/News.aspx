<%@ Page Language="C#" MasterPageFile="~/DefaultBackEnd.master" AutoEventWireup="true"
    CodeFile="News.aspx.cs" Inherits="Reskrimsus.Website.Administrator.News" Title="News" %>
                                                                                ...
                                                                                <table cellpadding="3" cellspacing="0" width="0" border="0">
                                                                                    <tr>
                                                                                        <td style="width: 285px;">
                                                                                            <asp:TextBox ID="KeywordValueTextBox" Width="300px" runat="server" placeholder="[Masukan nomor berita atau nama berita disini]"></asp:TextBox>
                                                                                        </td>
                                                                                        <td>
                                                                                                        ...
                                                                                                        <ItemTemplate>
                                                                                                            <tr id="RepeaterItemTemplate" runat="server">
                                                                                                                ...
                                                                                                                <%-- <div style="overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-box-orient: vertical;
                                                                                                                        -webkit-line-clamp: 3px; line-height: 100px; max-height: 200px; max-width: 200px;
                                                                                                                        /* fallback */">
                                                                                                                    </div>--%>
                                                                                                                <%--<div style="overflow: hidden; text-overflow: ellipsis; max-width: 200px; line-height: 2;
                                                                                                                        max-height: 150px; display: -webkit-box; -webkit-box-orient: vertical;">
