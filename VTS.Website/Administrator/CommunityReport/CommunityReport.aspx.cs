...
namespace Reskrimsus.Website.Administrator
{
    public partial class CommunityReport : Base
    {
        ...
        {
            IEnumerable<WsCommunityReport> _tempList = new List<WsCommunityReport>();
            _tempList = this._webContentBL.GetListWsCommunityReport();
            ...
            if (this.KeywordValueTextBox.Text != "")
                _tempList = _tempList.Where(x => x.Notes.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()) || x.Remark.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()) || x.CommunityName.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                WsCommunityReport _temp = (WsCommunityReport)e.Item.DataItem;
                String _code = Convert.ToString(_temp.CommunityId);
                ...
                _IdLiteral.Text = HttpUtility.HtmlEncode(_temp.CommunityId.ToString());

                Literal _NamaLiteral = (Literal)e.Item.FindControl("NamaLiteral");
                _NamaLiteral.Text = HttpUtility.HtmlEncode(_temp.CommunityName);
        ...
        protected void ShowDataDetail(String _prmId)
        {
            try
            {
                ...
                WsCommunityReport _detail = this._webContentBL.GetSingleWsCommunityReport(Convert.ToInt32(_prmId));
                this.IdTextBox.Text = _detail.CommunityId.ToString();
                this.NameTextBox.Text = _detail.CommunityName;
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _temp = this._webContentBL.GetSingleWsCommunityReport(Convert.ToInt32(this.IdTextBox.Text));

                    _temp.EditBy = _userName;
                    _temp.EditDate = DateTime.Now;
                }
                _temp.CommunityName = this.NameTextBox.Text;
                _temp.Remark = this.BodyTextBox.Content;
                _temp.Notes = this.NotesTextBox.Text;
                ...
                if (this.ActionHidden.Value == "Add")
                {
                    ...
                    _result = this._webContentBL.AddWsCommunityReport(_temp);
                ...
                else if (this.ActionHidden.Value == "Edit")
                {
                    ...
                    _result = this._webContentBL.EditWsCommunityReport(_temp);
                }
                ...
                if (_result)
                {
                    ...
                    this.ActionHidden.Value = "Edit";
                    this.ShowDataDetail(_temp.CommunityId.ToString());
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._webContentBL.DeleteMultiWsCommunityReport(_a);
            if (_result)
            {
                this.PanelView.Visible = false;
                this.ShowData(0);
