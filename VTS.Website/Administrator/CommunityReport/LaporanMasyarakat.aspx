<%@ Page Language="C#" MasterPageFile="~/DefaultBackEnd.master" AutoEventWireup="true"
    CodeFile="LaporanMasyarakat.aspx.cs" Inherits="Reskrimsus.Website.Administrator.CommunityReport"
                    ...
                    <table cellpadding="3" cellspacing="0" width="100%" border="0">
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td class="pageLiteral">Laporan Masyarakat
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                                                                ...
                                                                                <table cellpadding="3" cellspacing="0" width="0" border="0">
                                                                                    <tr>
                                                                                        <td style="width: 285px;">
                                                                                            <asp:TextBox ID="KeywordValueTextBox" Width="300px" runat="server" placeholder="[Masukan nomor laporan atau nama laporan disini]"></asp:TextBox>
                                                                                        </td>
                                                                                        <td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan="2">
                                                                                                ...
                                                                                                <table cellpadding="3" cellspacing="1" width="0" border="0" width="100%">
                                                                                                    ...
                                                                                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemCommand="ListRepeater_ItemCommand" OnItemDataBound="ListRepeater_ItemDataBound">
                                                                                                        <ItemTemplate>
                                                                                                            ...
                                                                                                            <tr id="RepeaterItemTemplate" runat="server">
                                                                                                                ...
                                                                                                                <td align="center">
                                                                                                                    <asp:Literal runat="server" ID="PerihalLiteral"></asp:Literal>
                                                                                                                </td>
                                                                                                                <td align="center">
                                                                                                                    <asp:Literal runat="server" ID="LaporanLiteral"></asp:Literal>
                                                                                                                </td>
                                                                                                                <td align="center">
                                    ...
                                    <td>
                                        <table border="0" cellpadding="3" cellspacing="0" width="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="NamaTextBox" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Email
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="HandphoneTextBox" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <td>Perihal
                                                ...
                                                <td>
                                                    ...
                                                    <asp:TextBox ID="PerihalTextBox" runat="server" />
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <td>Isi
                                                ...
                                                <td>
                                                    ...
                                                    <asp:TextBox ID="IsiTextBox" TextMode="MultiLine" runat="server" />
                                                </td>
                                            </tr>
                                            <%--<tr valign="top">
                                                <td>
