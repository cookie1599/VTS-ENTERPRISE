...
{
    public partial class CommunityReport : Base
    {
        ...
        {
            IEnumerable<WsLaporanMasyarakat> _tempList = new List<WsLaporanMasyarakat>();
            _tempList = this._webContentBL.GetListWsLaporanMasyarakat();
            ...
            if (this.KeywordValueTextBox.Text != "")
                _tempList = _tempList.Where(x => x.Perihal.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()) || x.Pesan.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()));
        ...
        private void SetComponent(String _prmAction)
        {
            if (_prmAction == "Disable")
            {
                ...
                this.PerihalTextBox.Enabled = false;
                this.IsiTextBox.Enabled = false;
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                HiddenField _idHiddenField = (HiddenField)e.Item.FindControl("IDHiddenField");
                _idHiddenField.Value = _temp.id.ToString();
                ...
                _Nameliteral.Text = HttpUtility.HtmlEncode(_temp.Nama);
                ...
                //_BodyLiteral.Text = _temp.Remark;

                //Literal _NotesLiteral = (Literal)e.Item.FindControl("NotesLiteral");
                //_NotesLiteral.Text = HttpUtility.HtmlEncode(_temp.Notes);

                Literal _PhoneLiteral = (Literal)e.Item.FindControl("PhoneLiteral");
                _PhoneLiteral.Text = HttpUtility.HtmlEncode(_temp.Handphone);

                Literal _PerihalLiteral = (Literal)e.Item.FindControl("PerihalLiteral");
                _PerihalLiteral.Text = HttpUtility.HtmlEncode(_temp.Perihal);

                Literal _LaporanLiteral = (Literal)e.Item.FindControl("LaporanLiteral");
                _LaporanLiteral.Text = HttpUtility.HtmlEncode(_temp.Pesan);
        ...
        protected void ListRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            WsContactUs _checkExist = this._webContentBL.GetSingleWsContactUs(Convert.ToInt32(_value[0]));
            ...
            else if (e.CommandName.ToString() == "Edit")
            {
                ...
                //this.CriteriaDetailPanel.Visible = true;
                this.idHiddenField.Value = _value[0];
        ...
        protected void ShowDataDetail(String _prmId)
        {
            try
            {
                ...
                WsLaporanMasyarakat _detail = this._webContentBL.GetSingleWsLaporanMasyarakat(Convert.ToInt32(_prmId));
                this.NamaTextBox.Text = _detail.Nama;
                this.EmailTextBox.Text = _detail.Email;
                this.HandphoneTextBox.Text = _detail.Handphone;
                this.PerihalTextBox.Text = _detail.Perihal;
                this.IsiTextBox.Text = _detail.Pesan;
                ...
                //this.NotesTextBox.Text = _detail.Notes;
            }
            catch (Exception ex)
            {
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                WsLaporanMasyarakat _temp = this._webContentBL.GetSingleWsLaporanMasyarakat(Convert.ToInt32(this.idHiddenField.Value));
                ...
                //}
                if (this.ActionHidden.Value == "Edit")
                {
                    //_temp = this._webContentBL.GetSingleWsLaporanMasyarakat(Convert.ToInt32(this.id.Text));
                    _temp.EditBy = _userName;
                    _temp.EditDate = DateTime.Now;
                }
                _temp.Nama = this.NamaTextBox.Text;
                _temp.Email = this.EmailTextBox.Text;
                _temp.Handphone = this.HandphoneTextBox.Text;
                _temp.Perihal = this.PerihalTextBox.Text;
                _temp.Pesan = this.IsiTextBox.Text;
                ...
                if (this.ActionHidden.Value == "Edit")
                {
                    ...
                    _result = this._webContentBL.EditLaporanMasyarakat(_temp);
                }
                ...
                if (_result)
                {
                    ...
                    this.ActionHidden.Value = "Edit";
                    this.ShowDataDetail(_temp.id.ToString());
                }
                else
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (RepeaterItem _item in this.ListRepeater.Items)
            {
                ...
                HiddenField _idHiddenField = (HiddenField)_item.FindControl("IDHiddenField");

                if (_listCheckbox.Checked)
                {
                    _id.Add(_idHiddenField.Value);
                }
            }
            //string[] _a = this.CheckHidden.Value.Split(',');
            bool _result = this._webContentBL.DeleteMultiWsLaporanMasyarakat(_id.ToArray());
            if (_result)
            {
                this.PanelView.Visible = false;
                this.ShowData(0);
