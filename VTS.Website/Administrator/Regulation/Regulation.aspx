<%@ Page Language="C#" MasterPageFile="~/DefaultBackEnd.master" AutoEventWireup="true"
    CodeFile="Regulation.aspx.cs" Inherits="Reskrimsus.Website.Administrator.Regulation"
    Title="Regulation" %>
                                                                                ...
                                                                                <table cellpadding="3" cellspacing="0" width="0" border="0">
                                                                                    <tr>
                                                                                        <td style="width: 285px;">
                                                                                            <asp:TextBox ID="KeywordValueTextBox" Width="300px" runat="server" placeholder="[Masukan nomor peraturan atau nama peraturan disini]"></asp:TextBox>
                                                                                        </td>
                                                                                        <td>
                                                    ...
                                                    <table>
                                                        <tr id="DownloadTr" runat="server">
                                                            <td>
                                                                ...
                                                                <asp:HyperLink ID="DownloadHyperLink" runat="server" Target="_blank" Text="Rekomendasi Format File (.pdf/.doc)"></asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
