<%@ Page Language="C#" MasterPageFile="~/DefaultBackEnd.master" AutoEventWireup="true"
    ValidateRequest="false" CodeFile="Structure.aspx.cs" Inherits="Reskrimsus.Website.Administrator.Structure"
    Title="Structure" %>
                                                                                ...
                                                                                <table cellpadding="3" cellspacing="0" width="0" border="0">
                                                                                    <tr>
                                                                                        <td style="width: 285px;">
                                                                                            <asp:TextBox ID="KeywordValueTextBox" Width="300px" runat="server" placeholder="[Masukan nomor atau nama structure disini]"></asp:TextBox>
                                                                                        </td>
                                                                                        <td>
                            ...
                            <table cellpadding="3" cellspacing="0" width="100%" border="0">
                                    ...
                                    <td>
                                        <table border="0" cellpadding="3" cellspacing="0" width="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:CheckBox ID="FgActiveCheckBox" runat="server" Visible="false" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        &nbsp
                                        <asp:Button ID="SaveAndNewButton" runat="server" Text="Simpan dan Tambah" OnClick="SaveAndNewButton_Click" />
                                        &nbsp;
