<%@ Page Language="C#" MasterPageFile="~/DefaultBackEnd.master" AutoEventWireup="true"
    CodeFile="User.aspx.cs" Inherits="Reskrimsus.Website.Administrator.User" Title="User" %>
            ...
            <div id="content">
                                                                                ...
                                                                                <table cellpadding="3" cellspacing="0" width="0" border="0">
                                                                                    <tr>
                                                                                        <td style="width: 285px;">
                                                                                            <asp:TextBox ID="KeywordValueTextBox" Width="300px" runat="server" placeholder="[Masukkan Nama User disini]"></asp:TextBox>
                                                                                        </td>
                                                                                        <td>
                ...
                <div style="float: left; margin-bottom: 54px; margin-top: 279px;">
                    <asp:Panel runat="server" ID="PanelView">
                        <fieldset style="width: 500px; margin-left: 94px; margin-top: -78px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="NameTextBox"
                                                        Text="*" ErrorMessage="Nama User Harus Diisi."></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="PasswordTextBox"
                                                        Text="*" ErrorMessage="Password Harus Diisi."></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RoleRFV" runat="server" ControlToValidate="RoleDropDownList"
                                                        Text="*" ErrorMessage="Role user harus dipilih."></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
