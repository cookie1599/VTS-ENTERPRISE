<%@ Page Language="C#" MasterPageFile="~/DefaultBackEnd.master" AutoEventWireup="true"
    CodeFile="GalleryVideo.aspx.cs" Inherits="Reskrimsus.Website.Administrator.GalleryVideo" EnableEventValidation="true"
    Title="Gallery Video" %>
                                                                                ...
                                                                                <table cellpadding="3" cellspacing="0" width="0" border="0">
                                                                                    <tr>
                                                                                        <td style="width: 285px;">
                                                                                            <asp:TextBox ID="KeywordValueTextBox" Width="300px" runat="server" placeholder="[Masukan nama banner atau no banner disini]"></asp:TextBox>
                                                                                        </td>
                                                                                        <td>
                                                                                                    ...
                                                                                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemCommand="ListRepeater_ItemCommand"
                                                                                                        ...
                                                                                                        <ItemTemplate>
                                                                                                            <tr id="RepeaterItemTemplate" runat="server">
                                                                                                                ...
                                                                                                                <td align="left">
                                                                                                                    <asp:Literal runat="server" ID="JudulGaleryLiteral"></asp:Literal>
                                                                                                                </td>
                                                                                                                <td align="center">
                                                                                                                ...
                                                                                                                <td align="center">
                                                                                                                    <asp:Literal runat="server" ID="ModifiedByLiteral"></asp:Literal>
                                                                                                                </td>
                                                                                                                <td align="center">
                                    ...
                                    <td>
                                        <table border="0" cellpadding="3" cellspacing="0" width="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="JudulGaleryTextBox" runat="server"></asp:TextBox>
                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="JudulGaleryTextBox"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox CssClass="buttonNoStyle" ID="PeriodeTextBox" runat="server" Width="80"
                                                        BackColor="#CCCCCC"></asp:TextBox>
                                                    <input cssclass="buttonNoStyle" id="button2" type="button" onclick="displayCalendar(ctl00_ContentPlaceHolder1_PeriodeTextBox,'yyyy-mm-dd',this)"
                                                    ...
                                                    <table>
                                                        <tr id="VideoTr" runat="server">
                                                            <td>
                                                                ...
                                                                <asp:Literal ID="VideoLiteral" runat="server"/>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                Rekomendasi Format File (.mp4)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
