...
{
    public partial class GalleryEvent : Base
    {
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            IEnumerable<WsGalleryEvent> _tempList = new List<WsGalleryEvent>();
            _tempList = this._webContentBL.GetListWsGalleryEventAllStatus();
            ...
            if (this.KeywordValueTextBox.Text != "")
                _tempList = _tempList.Where(x => x.EventTitle.ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()) || x.EventId.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                String _code = Convert.ToString(_temp.EventId);
                ...
                _IdLiteral.Text = HttpUtility.HtmlEncode(_temp.EventId.ToString());

                Literal _NamaLiteral = (Literal)e.Item.FindControl("JudulGaleryLiteral");
                _NamaLiteral.Text = HttpUtility.HtmlEncode(_temp.EventTitle);

                Literal _PeriodeLiteral = (Literal)e.Item.FindControl("PeriodeLiteral");
                _PeriodeLiteral.Text = HttpUtility.HtmlEncode(Convert.ToDateTime(_temp.EventPeriod).ToString("d-M-yyyy"));
        ...
        protected void ListRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            WsGalleryEvent _checkExist = this._webContentBL.GetSingleWsGalleryEvent(_value[0]);
        ...
        protected void ShowDataDetail(String _prmWsGalleryEvent)
        {
            try
            {
                this.IdTextBox.Enabled = false;
                ...
                WsGalleryEvent _detail = this._webContentBL.GetSingleWsGalleryEvent(_prmWsGalleryEvent);
                this.IdTextBox.Text = _detail.EventId.ToString();
                this.JudulGaleryTextBox.Text = _detail.EventTitle;
                this.PeriodeTextBox.Text = Convert.ToDateTime(_detail.EventPeriod).ToString("yyyy-MM-dd");
                this.BodyTextBox.Content = _detail.EventDescription;
                this.FileImage.ImageUrl = this.PhotoURLHidden.Value + _detail.EventFile;
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                WsGalleryEvent _temp = new WsGalleryEvent();
                ...
                {
                    _temp = this._webContentBL.GetSingleWsGalleryEvent(this.IdTextBox.Text);

                    _temp.ModifiedBy = _userName;
                    _temp.ModifiedDate = DateTime.Now;
                }
                _temp.EventTitle = this.JudulGaleryTextBox.Text;
                _temp.EventPeriod = Convert.ToDateTime(this.PeriodeTextBox.Text);
                _temp.EventDescription = this.BodyTextBox.Content;
                        ...
                        foreach (var _item in _extensionAllowedArray)
                        {
                            if (this.FileImageUpload.FileName.Split('.')[1].ToLower() == _item)
                            {
                                ...
                                if (this.PhotoDirectoryHidden.Value != "")
                                {
                                    ...
                                    _temp.EventFile = _fileName + _fileInfo.Extension;
                ...
                if (this.ActionHidden.Value == "Add")
                {
                    if (_upload == true)
                    {
                        _result = this._webContentBL.AddWsGalleryEvent(_temp);
                    }
                ...
                else if (this.ActionHidden.Value == "Edit")
                {
                    ...
                    _result = this._webContentBL.EditWsGalleryEvent(_temp);
                }
                ...
                if (_result)
                {
                    ...
                    this.ActionHidden.Value = "Edit";
                    this.ShowDataDetail(_temp.EventId.ToString());
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._webContentBL.DeleteMultiWsGalleryEvent(_a);
            if (_result)
            {
                this.PanelView.Visible = false;
                this.ShowData(0);
