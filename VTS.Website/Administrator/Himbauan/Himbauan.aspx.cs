...
{
    public partial class Himbauan : Base
    {
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            IEnumerable<WsHimbauan> _tempList = new List<WsHimbauan>();
            _tempList = this._webContentBL.GetListWsHimbauan();
            ...
            if (this.KeywordValueTextBox.Text != "")
                _tempList = _tempList.Where(x => x.HimbauanName.ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()) || x.HimbauanId.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                WsHimbauan _temp = (WsHimbauan)e.Item.DataItem;
                String _code = Convert.ToString(_temp.HimbauanId);
                ...
                //_IdLiteral.Text = HttpUtility.HtmlEncode(_temp.HimbauanId.ToString());

                Literal _NamaLiteral = (Literal)e.Item.FindControl("NamaLiteral");
                _NamaLiteral.Text = HttpUtility.HtmlEncode(_temp.HimbauanName);
        ...
        protected void ListRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            WsHimbauan _checkExist = this._webContentBL.GetSingleWsHimbauan(_value[0]);
        ...
        protected void ShowDataDetail(String _prmPenyidikHd)
        {
            try
            {
                ...
                WsHimbauan _detail = this._webContentBL.GetSingleWsHimbauan(_prmPenyidikHd);
                this.IdLiteral.Text = _detail.HimbauanId.ToString();
                this.NameTextBox.Text = _detail.HimbauanName;
        ...
        protected void CheckValidData()
        {
            ...
            if (this.PhotoUpload.PostedFile.ContentLength != 0)
            {
                ...
                //    this.WarningLabel.Text = "Himbauan yang Anda masukkan tidak proporsional. Size gambar harus 920px x 265px.";
            }
            if (this.IdTr.Visible == false)
            {
                if (this.PhotoUpload.PostedFile.ContentLength == 0)
                {
                    this.WarningLabel.Text = "Himbauan harus diunggah.";
                }
            }
        ...
        private void Save(Boolean _prmSaveAndNew)
        {
            try
            {
                ...
                if (this.WarningLabel.Text == "")
                {
                    bool _result = false;
                    //
                    WsHimbauan _temp = new WsHimbauan();
                    ...
                    {
                        _temp = this._webContentBL.GetSingleWsHimbauan(this.IdLiteral.Text);
                    ...
                    if (this.PhotoUpload.PostedFile.ContentLength != 0)
                    {
                        ...
                        String _fileName = "Himbauan-" + DateTime.Now.ToString("yyyyMMddHHmmss");
                    ...
                    _temp.HimbauanName = this.NameTextBox.Text;
                    _temp.Body = this.BodyTextBox.Content;
                    _temp.FgActive = (this.FgActiveCheckBox.Checked == true ? "Y" : "N");


                    if (this.IdTr.Visible == false)
                        _result = this._webContentBL.AddWsHimbauan(_temp);
                    else
                        _result = this._webContentBL.EditWsHimbauan(_temp);
                    ...
                    if (_result)
                    {
                        ...
                        else
                        {
                            ...
                            this.IdTr.Visible = true;
                            this.ShowDataDetail(_temp.HimbauanId.ToString());
                        }
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._webContentBL.DeleteMultiWsHimbauan(_a);
            if (_result)
            {
                this.PanelView.Visible = false;
                this.ShowData(0);
