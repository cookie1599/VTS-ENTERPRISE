<%@ Page Language="C#" MasterPageFile="~/DefaultBackEnd.master" AutoEventWireup="true"
    CodeFile="Link.aspx.cs" Inherits="Reskrimsus.Website.Administrator.Link" Title="Link" %>
                                                                                ...
                                                                                <table cellpadding="3" cellspacing="0" width="0" border="0">
                                                                                    <tr>
                                                                                        <td style="width: 285px;">
                                                                                            <asp:TextBox ID="KeywordValueTextBox" Width="300px" runat="server" placeholder="[Masukan Nama LINK disini]"></asp:TextBox>
                                                                                        </td>
                                                                                        <td>
                                                                                                        ...
                                                                                                        <ItemTemplate>
                                                                                                            <tr id="RepeaterItemTemplate" runat="server">
                                                                                                                ...
                                                                                                                <td align="left">
                                                                                                                    ...
                                                                                                                    <%--<asp:LinkButton runat="server" ID="BodyLiteral"></asp:LinkButton>--%>
                                                                                                                </td>
                                                                                                                <td align="center">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="NameTextBox" runat="server"></asp:TextBox>
                                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="NameTextBox"
                                                        Text="*" ErrorMessage="Nama Harus Diisi."></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr visible="false">
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="BodyTextBox" runat="server"></asp:TextBox>
                                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="BodyTextBox"
                                                        Text="*" ErrorMessage="Link Harus Diisi."></asp:RequiredFieldValidator>
                                                    <%--<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
                                                    </asp:ToolkitScriptManager>
                                                    <cc1:Editor ID="BodyTextBox" runat="server" Visible="false" />--%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
