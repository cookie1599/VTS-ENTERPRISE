...
{
    public partial class Link : Base
    {
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            if (this.KeywordValueTextBox.Text != "")
                _tempList = _tempList.Where(x => x.NamaLink.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()) || x.Link.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                _NamaLiteral.Text = HttpUtility.HtmlEncode(_temp.NamaLink);

                Literal _BodyLiteral = (Literal)e.Item.FindControl("BodyLiteral");
                _BodyLiteral.Text = HttpUtility.HtmlEncode(_temp.Link);
        ...
        protected void ShowDataDetail(String _prmId)
        {
            try
            {
                ...
                WsLink _detail = this._webContentBL.GetSingleWsLink(Convert.ToInt32(_prmId));
                this.IdTextBox.Text = _detail.NoID.ToString();
                this.NameTextBox.Text = _detail.NamaLink;
                this.BodyTextBox.Text = _detail.Link;
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _temp = this._webContentBL.GetSingleWsLink(Convert.ToInt32(this.IdTextBox.Text));

                    //_temp.EditBy = _userName;
                    //_temp.EditDate = DateTime.Now;
                }
                _temp.NamaLink = this.NameTextBox.Text;
                _temp.Link = this.BodyTextBox.Text;
                ...
                if (this.ActionHidden.Value == "Add")
                {
                    ...
                    _result = this._webContentBL.AddWsLink(_temp);
                ...
                else if (this.ActionHidden.Value == "Edit")
                {
                    ...
                    _result = this._webContentBL.EditWsLink(_temp);
                }
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._webContentBL.DeleteMultiWsLink(_a);
            if (_result)
            {
                this.PanelView.Visible = false;
                this.ShowData(0);
