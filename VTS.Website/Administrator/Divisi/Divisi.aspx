<%@ Page Language="C#" MasterPageFile="~/DefaultBackEnd.master" AutoEventWireup="true"
    CodeFile="Divisi.aspx.cs" Inherits="Reskrimsus.Website.Administrator.Divisi" Title="Divisi" %>
            ...
            <div id="content">
                                                                                ...
                                                                                <table cellpadding="3" cellspacing="0" width="0" border="0">
                                                                                    <tr>
                                                                                        <td style="width: 285px;">
                                                                                            <asp:TextBox ID="KeywordValueTextBox" runat="server" placeholder="[Masukkan Divisi disini]"></asp:TextBox>
                                                                                        </td>
                                                                                        <td>
                ...
                <div style="float: left; margin-bottom: 54px; margin-top: 279px;">
                    <asp:Panel runat="server" ID="PanelView">
                        <fieldset style="width: 400px; margin-left: 94px; margin-top: -78px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="NameTextBox"
                                                        Text="*" ErrorMessage="Divisi Harus Diisi."></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
