<%@ Page Language="C#" MasterPageFile="~/DefaultBackEnd.master" AutoEventWireup="true"
    CodeFile="Banner.aspx.cs" Inherits="Reskrimsus.Website.Administrator.Banner"
    Title="Banner" %>
                                                                                                    ...
                                                                                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemCommand="ListRepeater_ItemCommand"
                                                                                                        ...
                                                                                                        <ItemTemplate>
                                                                                                            <tr id="RepeaterItemTemplate" runat="server">
                                                                                                                ...
                                                                                                                <td align="left">
                                                                                                                    <asp:Literal runat="server" ID="JudulLiteral"></asp:Literal>
                                                                                                                </td>
                                                                                                                <td align="left" style="width: 250px; height: 200px; overflow: hidden;">
                                                                                                                    <asp:Literal runat="server" ID="IsiLiteral"></asp:Literal>
                                                                                                                </td>
                                                                                                                <td align="center">
                            ...
                            <table cellpadding="3" cellspacing="0" width="100%" border="0">
                                        ...
                                        <table border="0" cellpadding="3" cellspacing="0" width="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="NameTextBox"
                                                        Text="*" ErrorMessage="Nama Banner Harus Diisi."></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <td>
                                                ...
                                                <td>
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                Ukuran Banner harus 1800px x 834px
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="BodyTextBox"
                                                        Text="*" ErrorMessage="Isi Harus Diisi."></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        &nbsp;
                                        <asp:Button ID="SaveAndNewButton" runat="server" OnClick="SaveAndNewButton_Click"
                                            Text="Simpan dan Tambah" />
