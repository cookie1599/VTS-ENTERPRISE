...
{
    public partial class UndangUndang : Base
    {
        ...
        {
            IEnumerable<WsUndangUndang> _tempList = new List<WsUndangUndang>();
            _tempList = this._webContentBL.GetListWsUndangUndang();
        ...
        private void Save(Boolean _prmSaveAndNew)
        {
            try
            {
                ...
                {
                    bool _result = false;
                    String _fileName = "UndangUndang-" + DateTime.Now.ToString("yyyyMMddHHmmss");
                    ...
                    {
                        _temp = this._webContentBL.GetSingleWsUndangUndang(Convert.ToInt32(this.IdLiteral.Text));
                        //_temp.EditBy = _userName;
                        //_temp.EditDate = DateTime.Now;
                        _temp.NamaFile = this.NameTextBox.Text;
                        //_temp.Remark = this.BodyTextBox.Content;
