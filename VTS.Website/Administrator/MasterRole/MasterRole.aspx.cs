...
{
    public partial class MasterRole : Base
    {
        ...
        {
            IEnumerable<MsRole> _tempList = new List<MsRole>();
            _tempList = this._userBL.GetListMsRole();
            ...
            if (this.KeywordValueTextBox.Text != "")
                _tempList = _tempList.Where(x => x.RoleName.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsRole _temp = (MsRole)e.Item.DataItem;
                String _code = Convert.ToString(_temp.RoleId);
                ...
                _IdLiteral.Text = HttpUtility.HtmlEncode(_temp.RoleId.ToString());

                Literal _NamaLiteral = (Literal)e.Item.FindControl("NamaLiteral");
                _NamaLiteral.Text = HttpUtility.HtmlEncode(_temp.RoleName);
        ...
        protected void ListRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (e.CommandName.ToString() == "View")
            {
                ...
                this.ActionHidden.Value = "View";
                //this.SaveDetailButton.Visible = false;
            ...
            else if (e.CommandName.ToString() == "Edit")
            {
                ...
                //this.SaveDetailButton.Visible = true;
        ...
        protected void ShowDataDetail(String _prmRoleId)
        {
            try
            {
                this.RoleIdHidden.Value = _prmRoleId;
                this.IdTextBox.Enabled = false;
                this.PanelList.Visible = true;
                this.PanelView.Visible = true;


                MsRole _detail = this._userBL.GetSingleMsRole(Convert.ToInt32(_prmRoleId));
                this.IdTextBox.Text = _detail.RoleId.ToString();
                this.NameTextBox.Text = _detail.RoleName;
                ...
                IEnumerable<MsMenu> _vwrolemenu = this._userBL.GetListMsMenu().OrderBy(x => x.ParentID).ThenBy(x => x.MenuId);
                List<MsMenu> _tempList1 = new List<MsMenu>();
                //List<vw_RoleMenu> _tempList2 = new List<vw_RoleMenu>();

                foreach (var _item in _vwrolemenu.Where(x => x.ParentID == 0))
                {
                    _item.Value = "<b>&nbsp" + _item.Value + "</b>";
                    _tempList1.Add(_item);
                    foreach (var _item2 in _vwrolemenu.Where(x => x.ParentID == _item.MenuId))
                    {
                        _item2.Value = "&nbsp &nbsp &nbsp" + _item2.Value;
                        _tempList1.Add(_item2);
                        foreach (var _item3 in _vwrolemenu.Where(x => x.ParentID == _item2.MenuId))
                        {
                            _item3.Value = "&nbsp &nbsp &nbsp &nbsp &nbsp" + _item3.Value;
                            _tempList1.Add(_item3);
                        }
                    }
                }

                this.ListMenuCheckBox.Items.Clear();
                this.ListMenuCheckBox.DataSource = _tempList1;
                this.ListMenuCheckBox.DataValueField = "MenuId";
                this.ListMenuCheckBox.DataTextField = "Value";
                this.ListMenuCheckBox.DataBind();

                foreach (ListItem item in ListMenuCheckBox.Items)
                {
                    item.Selected = false;
                    if (this.ActionHidden.Value == "View")
                        item.Enabled = false;
                    else
                        item.Enabled = true;
                }

                List<MsRoleMenu> _tempList2 = new List<MsRoleMenu>();
                _tempList2 = this._userBL.GetListMsRoleMenu(Convert.ToInt32(_prmRoleId));

                foreach (ListItem item in ListMenuCheckBox.Items)
                {
                    foreach (var item2 in _tempList2)
                    {
                        if (item2.MenuId.ToString() == item.Value)
                        {
                            item.Selected = true;
                        }
                    }
                ...
                //IEnumerable<vw_MenuPermission> _vw_MenuPermission = this._userBL.GetListvw_MenuPermission();

                //IEnumerable<vw_RoleMenu> _vw_RoleMenu = this._userBL.GetListvw_RoleMenu(Convert.ToInt32(_prmRoleId));
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _temp = this._userBL.GetSingleMsRole(Convert.ToInt32(this.IdTextBox.Text));

                    _temp.EditBy = _userName;
                    _temp.EditDate = DateTime.Now;
                }
                _temp.RoleName = this.NameTextBox.Text;
                ...
                if (this.ActionHidden.Value == "Add")
                {
                    ...
                    _result = this._userBL.AddMsRole(_temp);
                ...
                else if (this.ActionHidden.Value == "Edit")
                {
                    ...
                    _result = this._userBL.EditMsRole(_temp);
                }
                ...
                if (_result)
                {
                    ...
                    this.ActionHidden.Value = "Edit";
                    this.ShowDataDetail(_temp.RoleId.ToString());
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._userBL.DeleteMultiMsRole(_a);
            if (_result)
            {
                this.PanelView.Visible = false;
                this.ShowData(0);
        ...
        //protected void SaveDetailButton_Click(object sender, EventArgs e)
        //{
        //    try
        //    {
        //    String _a = "";

        //    List<MsRoleMenu> _tempList = new List<MsRoleMenu>();
        ...
        //        //else
        //        //    _a = _a + "," + _item.Value;
        //        MsRoleMenu _temp = new MsRoleMenu();
        //        _temp.RoleId = Convert.ToInt32(this.RoleIdHidden.Value);
        //        _temp.CreatedBy = this._userName;
        //        _temp.CreatedDate = DateTime.Now;
        //        _temp.EditBy = "";
        //        _temp.EditDate = Convert.ToDateTime("1900-01-01");
        //        _temp.FgActive = 'Y';
        ...
        //        _temp.FgEdit = 'Y';
        //        _temp.FgView = 'Y';
        //        _temp.MenuId = Convert.ToInt32(_item.Value);

        //        _tempList.Add(_temp);
        //    }

        //    bool _result = _userBL.AddListMsRoleMenu(this.RoleIdHidden.Value, _tempList);
        ...
        //        this.WarningLabel.Text = "Proses Berhasil";
        //        this.ActionHidden.Value = "Edit";
        //        this.ShowDataDetail(this.RoleIdHidden.Value);
