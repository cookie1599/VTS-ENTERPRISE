...
namespace Reskrimsus.Website.Administrator
{
    public partial class ContactUs : Base
    {
        ...
        {
            //IEnumerable<WsContactUs> _tempList = new List<WsContactUs>();
            //_tempList = this._webContentBL.GetListWsContactUs();
            ...
            //    _tempList = _tempList.Where(x => x.Remark.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()) || x.Title.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()));
            ...
            //companyconfiguration _companyconfiguration = this._companyConfigBL.GetSinglecompanyconfiguration("ContactUs");

            WsContactUs _temp = this._webContentBL.GetSingleWsContactUs(1);


            if (_temp != null)
            {
                if (this._generalBL.CheckExistFile(this.PhotoURLHidden.Value + _temp.Image))
                {
                    this.PhotoImage.ImageUrl = this.PhotoURLHidden.Value + _temp.Image;
                    this.PhotoImage.Attributes.Add("OnClick", "window.open('" + this.PhotoURLHidden.Value + _temp.Image + "')");
                }
                else
        ...
        //    {
        //        WsContactUs _temp = (WsContactUs)e.Item.DataItem;
        //        String _code = Convert.ToString(_temp.ContactUsId);
        ...
        //        _IdLiteral.Text = HttpUtility.HtmlEncode(_temp.ContactUsId.ToString());

        //        Literal _NamaLiteral = (Literal)e.Item.FindControl("NamaLiteral");
        //        _NamaLiteral.Text = HttpUtility.HtmlEncode(_temp.Title);
        ...
        //        WsContactUs _detail = this._webContentBL.GetSingleWsContactUs(Convert.ToInt32(_prmId));
        //        this.IdTextBox.Text = _detail.ContactUsId.ToString();
        //        this.NameTextBox.Text = _detail.Title;
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _temp = this._webContentBL.GetSingleWsContactUs(1);
                ...
                //{
                //    _temp = this._webContentBL.GetSingleWsContactUs(Convert.ToInt32(this.IdTextBox.Text));

                //    _temp.EditBy = _userName;
                //    _temp.EditDate = DateTime.Now;
                //}
                //_temp.Title = this.NameTextBox.Text;
                        ...
                        foreach (var _item in _extensionAllowedArray)
                        {
                            if (this.PhotoUpload.FileName.Split('.')[1].ToLower() == _item)
                            {
                                ...
                                if (this.PhotoDirectoryHidden.Value != "")
                                {
                                    ...
                                    String _fileName = "ContactUs" + DateTime.Now.ToString("yyyyMMddHHmmss");
                ...
                //if (this.ActionHidden.Value == "Add")
                {
                    ...
                    //_result = this._webContentBL.AddWsContactUs(_temp);
                ...
                _result = this._webContentBL.EditWsContactUs(_temp);
                ...
                if (_result)
                {
                    ...
                    //this.ActionHidden.Value = "Edit";
                    //this.ShowDataDetail(_temp.ContactUsId.ToString());
        ...
        //    bool _result = this._webContentBL.DeleteMultiWsContactUs(_a);
        //    if (_result)
        //    {
        //        this.PanelView.Visible = false;
        //        this.ShowData(0);
