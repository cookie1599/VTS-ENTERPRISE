...
function AskYouFirstToBuy() {
    ...
    if (confirm("Anda yakin untuk membeli barang ini?") == true) {
        _result = true;
    }
    else {
        _result = false;
...
function AskYouBookingMaid() {
    var _result = false;

    if (confirm("Are You Sure To Book This Maid?") == true) {
        _result = true;
    }
    else {
        _result = false;
...
function AskYouArrive2() {
    var _result = false;

    if (confirm("Document is Incomplete please Re-Check the Document!") == true) {
        _result = true;
    }
    else {
        _result = false;
...
function AskYouCross() {
    var _result = false;

    if (confirm("Are You Sure For Request Cross Selling?") == true) {
        _result = true;
    }
    else {
        _result = false;
...
function AskYouCrossFailed() {
    var _result = false;

    if (confirm("You already Request Cross Selling For This Maid") == true) {
        _result = false;
    }
    else {
        _result = false;
...
function AskYouAssignEmp() {
    var _result = false;

    if (confirm("Are you sure to add this Maid for this employer?") == true) {
        _result = false;
    }
    else {
        _result = false;
