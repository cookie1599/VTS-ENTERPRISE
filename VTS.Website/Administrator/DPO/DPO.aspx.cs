    ...
    public partial class DPO : Base
    {
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            if (this.KeywordValueTextBox.Text != "")
                _tempList = _tempList.Where(x => x.Remark.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()) || x.DPOName.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                _IdLiteral.Text = HttpUtility.HtmlEncode(_temp.DPOId.ToString());

                Literal _NamaLiteral = (Literal)e.Item.FindControl("NamaLiteral");
                _NamaLiteral.Text = HttpUtility.HtmlEncode(_temp.DPOName);
        ...
        protected void ShowDataDetail(String _prmId)
        {
            try
            {
                ...
                WsDPO _detail = this._webContentBL.GetSingleWsDPO(Convert.ToInt32(_prmId));
                this.IdLiteral.Text = _detail.DPOId.ToString();
                this.NameTextBox.Text = _detail.DPOName;
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            //        {
            //            _temp = this._webContentBL.GetSingleWsDPO(Convert.ToInt32(this.IdTextBox.Text));

            //            _temp.EditBy = _userName;
            //            _temp.EditDate = DateTime.Now;
            //        }
            //        _temp.DPOName = this.NameTextBox.Text;
            ...
            //            _result = this._webContentBL.AddWsDPO(_temp);
            ...
            //            _result = this._webContentBL.EditWsDPO(_temp);
            //        }
            ...
            //            this.ActionHidden.Value = "Edit";
            //            this.ShowDataDetail(_temp.DPOId.ToString());
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._webContentBL.DeleteMultiWsDPO(_a);
            if (_result)
            {
                this.PanelView.Visible = false;
                this.ShowData(0);
        ...
        private void Save(Boolean _prmSaveAndNew)
        {
            try
            {
                ...
                {
                    bool _result = false;
                    String _fileName = "DPO-" + DateTime.Now.ToString("yyyyMMddHHmmss");
                    ...
                    {
                        _temp = this._webContentBL.GetSingleWsDPO(Convert.ToInt32(this.IdLiteral.Text));
                        _temp.EditBy = _userName;
                        _temp.EditDate = DateTime.Now;
                        _temp.DPOName = this.NameTextBox.Text;
                        _temp.Remark = this.BodyTextBox.Content;
