...
{
    public partial class InfoPenyidikan : Base
    {
        ...
        {
            IEnumerable<WsInfoPenyidikan> _tempList = new List<WsInfoPenyidikan>();
            _tempList = this._webContentBL.GetListWsInfoPenyidikan();
            ...
            if (this.KeywordValueTextBox.Text != "")
                _tempList = _tempList.Where(x => x.Title.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()) || x.Body.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                WsInfoPenyidikan _temp = (WsInfoPenyidikan)e.Item.DataItem;
                String _code = Convert.ToString(_temp.InfoPenyidikanId);
                ...
                _IdLiteral.Text = HttpUtility.HtmlEncode(_temp.InfoPenyidikanId.ToString());
                ...
                //_BodyLiteral.Text = HttpUtility.HtmlEncode(_temp.Body);
        ...
        protected void ListRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            WsInfoPenyidikan _checkExist = this._webContentBL.GetSingleWsInfoPenyidikan(Convert.ToInt32(_value[0]));
        ...
        protected void ShowDataDetail(String _prmId)
        {
            try
            {
                ...
                WsInfoPenyidikan _detail = this._webContentBL.GetSingleWsInfoPenyidikan(Convert.ToInt32(_prmId));
                this.IdTextBox.Text = _detail.InfoPenyidikanId.ToString();
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _temp = this._webContentBL.GetSingleWsInfoPenyidikan(Convert.ToInt32(this.IdTextBox.Text));
                ...
                if (this.ActionHidden.Value == "Add")
                {
                    _result = this._webContentBL.AddWsInfoPenyidikan(_temp);
                }
                else if (this.ActionHidden.Value == "Edit")
                {
                    _result = this._webContentBL.EditWsInfoPenyidikan(_temp);
                }
                ...
                if (_result)
                {
                    ...
                    this.ActionHidden.Value = "Edit";
                    this.ShowDataDetail(_temp.InfoPenyidikanId.ToString());
                }
                else
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._webContentBL.DeleteMultiWsInfoPenyidikan(_a);
            if (_result)
            {
                this.PanelView.Visible = false;
                this.ShowData(0);
