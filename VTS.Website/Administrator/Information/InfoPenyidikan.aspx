<%@ Page Language="C#" MasterPageFile="~/DefaultBackEnd.master" AutoEventWireup="true"
    CodeFile="InfoPenyidikan.aspx.cs" Inherits="Reskrimsus.Website.Administrator.InfoPenyidikan"
    Title="Info Penyidikan" %>
        ...
        <div id="main-content" role="main">
            <div id="content">
                <table cellpadding="3" cellspacing="0" width="100%" border="0">
                    <tr>
                        <td class="pageLiteral" colspan="2">
                            Info Penyidikan
                        </td>
                    </tr>
                    <tr>
                                                                ...
                                                                <table cellpadding="3" cellspacing="0" width="0" border="0">
                                                                    <tr>
                                                                        <td style="width: 285px;">
                                                                            <asp:TextBox ID="KeywordValueTextBox" Width="300px" runat="server" placeholder="[Masukan Info Penyidikan disini]"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellpadding="3" cellspacing="0" width="100%" border="0">
                                                            <tr>
                                                                <td>
                                                                    <asp:Button runat="server" Visible="false" ID="DeleteButton" OnClick="DeleteButton_Click"
                                                                        CausesValidation="false" Text="Hapus" />
                                                                    <asp:HiddenField runat="server" ID="AskYouFirst" />
                                                                    </asp> &nbsp
                                                                    <asp:Button runat="server" ID="AddButton" Visible="false" OnClick="AddButton_Click"
                                                                        CausesValidation="false" Text="Tambah" />
                                                                </td>
                                                                <td align="right">
                        ...
                        <td>
                            <asp:Panel runat="server" ID="PanelView">
                                <fieldset style="width: 600px; margin-left: 0px; margin-top: 30px;">
