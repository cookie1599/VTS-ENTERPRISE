...
{
    public partial class Information : Base
    {
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            if (this.KeywordValueTextBox.Text != "")
                _tempList = _tempList.Where(x => x.Remark.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()) || x.InformationName.ToString().ToLower().Contains(this.KeywordValueTextBox.Text.ToLower()));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                _IdLiteral.Text = HttpUtility.HtmlEncode(_temp.InformationId.ToString());

                Literal _NamaLiteral = (Literal)e.Item.FindControl("NamaLiteral");
                _NamaLiteral.Text = HttpUtility.HtmlEncode(_temp.InformationName);

                //Literal _BodyLiteral = (Literal)e.Item.FindControl("BodyLiteral");
                //_BodyLiteral.Text = _temp.Remark.Length > 250 ? _temp.Remark.Substring(0, 250) + "..." : _temp.Remark;
        ...
        protected void ShowDataDetail(String _prmId)
        {
            try
            {
                ...
                WsInformation _detail = this._webContentBL.GetSingleWsInformation(Convert.ToInt32(_prmId));
                this.IdTextBox.Text = _detail.InformationId.ToString();
                this.NameTextBox.Text = _detail.InformationName;
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.PhotoUpload.PostedFile.ContentLength != 0)
                {
                    ...
                    WsInformation _temp = new WsInformation();
                    ...
                    {
                        _temp = this._webContentBL.GetSingleWsInformation(Convert.ToInt32(this.IdTextBox.Text));

                        _temp.EditBy = _userName;
                        _temp.EditDate = DateTime.Now;
                    }
                    _temp.InformationName = this.NameTextBox.Text;
                    ...
                    if (this.ActionHidden.Value == "Add")
                    {
                        ...
                        _result = this._webContentBL.AddWsInformation(_temp);
                    ...
                    else if (this.ActionHidden.Value == "Edit")
                    {
                        ...
                        _result = this._webContentBL.EditWsInformation(_temp);
                    }
                    ...
                    if (_result)
                    {
                        ...
                        this.ActionHidden.Value = "Edit";
                        this.ShowDataDetail(_temp.InformationId.ToString());
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._webContentBL.DeleteMultiWsInformation(_a);
            if (_result)
            {
                this.PanelView.Visible = false;
                this.ShowData(0);
