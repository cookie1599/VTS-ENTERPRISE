...
(function($) {
    ...
    $.fn.coinslider = $.fn.CoinSlider = function(options) {
        ...
        var setFields = function(el) {
            ...
            for (i = 1; i <= params[el.id].sph; i++) {
                ...
                for (j = 1; j <= params[el.id].spw; j++) {
                    ...
                    if (params[el.id].links) {
                        $('#' + el.id).append("<a href='" + links[el.id][0] + "' class='cs-" + el.id + "' id='cs-" + el.id + i + j + "' style='width:100%;" + "height:" + sHeight + "px; float: left; position: absolute;'></a>");
                    } else {
                        $('#' + el.id).append("<div class='cs-" + el.id + "' id='cs-" + el.id + i + j + "' style='width:100%;" + "height:" + sHeight + "px; float: left; position: absolute;'></div>");
                    }
        ...
        var appereance = function(el, sid) {
            ...
            $('#cs-' + el.id + sid).css({ opacity: 0, 'background-image': 'url("' + images[el.id][imagePos[el.id]] + '")', 'background-repeat':'no-repeat', 'background-size':'cover' });
    ...
    $.fn.coinslider.defaults = {
        ...
        height: 700, // height of slider panel
