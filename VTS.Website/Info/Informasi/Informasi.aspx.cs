...
public partial class Informasi : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (_test == "" || _test == "0" || _test == null)
        {
            _temp = this._webContentBL.GetWsInformationByLastPost();
            this.TitleLiteral.Text = _temp.InformationName;
            this.BodyLiteral.Text = _temp.Remark;
            this.PhotoImage.ImageUrl = this.PhotoURLHidden.Value + _temp.Image;
        }
        else
        {
            _temp = this._webContentBL.GetSingleWsInformation(Convert.ToInt32(_test));
            this.TitleLiteral.Text = _temp.InformationName;
            this.BodyLiteral.Text = _temp.Remark;
            this.PhotoImage.ImageUrl = this.PhotoURLHidden.Value + _temp.Image;
        }
