...
public partial class Info_DPO : System.Web.UI.Page
{
    ...
    protected int _no = 0;
    protected int _nomor = 0;

    protected int _no2 = 0;
    protected int _nomor2 = 0;

    protected string _awal = "ctl00_DefaultBodyContentPlaceHolder_ListRepeater_ctl";
    protected string _awalDt = "ctl00_DefaultBodyContentPlaceHolder_ListRepeaterDetail_ctl";


    CompanyConfigBL _compConfigBL = new CompanyConfigBL();
    WebsiteContentBL _contentBL = new WebsiteContentBL();
    ...
    {
        List<WsUndangUndang> _uu = new List<WsUndangUndang>();
        _uu = this._contentBL.GetListWsUndangUndang();
    ...
    protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            WsUndangUndang _temp = (WsUndangUndang)e.Item.DataItem;
    ...
    {
        double _result = 0;
        foreach (var _item in this._contentBL.GetListWsUndangUndang())
            _result += 1;
        _result += 1;
