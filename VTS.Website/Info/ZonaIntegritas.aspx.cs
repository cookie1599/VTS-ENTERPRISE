...
public partial class Info_DPO : System.Web.UI.Page
{
    ...
    {
        List<WsZonaIntegrita> _uu = new List<WsZonaIntegrita>();
        _uu = this._contentBL.GetListWsZonaIntegritas();
    ...
    {
        double _result = 0;
        foreach (var _item in this._contentBL.GetListWsZonaIntegritas())
            _result += 1;
        _result += 1;
